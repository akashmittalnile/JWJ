...
<body>
			...
			<div class="row">
				<div class="col-md-8 col-lg-6 col-sm-8">
					<div class="about-content-info">
						<h1>Why Journey with Journals? </h1>
						<p>Journey with Journals gives you a simple and easy to use platform for you to document your journey through Life! Each day comes to us one at a time. It is up to you to record and cherish moments that happen along your journey. It may not seem important now, but down the road of life you will appreciate the ability to go back and experience those special moments you had with family and friends.</p>
						<p>Journey with Journals gives you the means to overcome all the obstacles that have kept you from recording your memories. The days of finding a pen and your journal book are in the past. Finding time to preserve your memories is no longer an issue. Losing your journal in moves, disasters, changes in lifestyles are now not an issue as your journal is safe and secure in the cloud. You no longer have to worry about others reading your most sacred thoughts. If you change operating systems or just take a break from journaling, you can pick up right where you left off. Then when you’re ready to preserve it for your family you can print your entries for a Journal Binder.</p>
					</div>
				</div>
		...
		<div class="container">
				...
				<div class="row">
					<div class="col-md-5 col-lg-5 col-sm-5">
						<div class="service-media">
							<img src="{{ assets('assets/special/images/journals.svg') }}">
						</div>
					</div>
					<div class="col-md-7 col-lg-7 col-sm-7">
						<div class="service-content-info">
							...
							<ul>
								...
								<li>Children or Grandchildren activities</li>
								<li>Stressful moments</li>
								<li>Job functions</li>
								<li>New car</li>
								<li>Day at the lake</li>
								<li>Vacation</li>
								<li>Spiritual impressions</li>
								<li>Business adventures</li>
								<li>Just a lot on your mind</li>
								<li>Luncheon’s</li>
								...
								<li>Graduations</li>
								<li>Home projects</li>
								<li>Anything that is important to You!</li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="service-list" id="routines-id">
				<div class="row mt-2">
					<div class="col-md-7 col-lg-7 col-sm-7">
						<div class="service-content-info">
							...
							<ul>
								...
								<li>To do my sit-ups at night @ 8pm</li>
								<li>To add to my savings on payday</li>
								<li>To water my plants every Tuesday @ 5pm</li>
								<li>To take my vitamins on Monday, Wednesday, Friday @ 8am</li>
							</ul>
						</div>
					</div>
					...
					<div class="col-md-5 col-lg-5 col-sm-5">
						<div class="service-media">
							<img src="{{ assets('assets/special/images/routine.svg') }}">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-7 col-lg-7 col-sm-7">
						<div class="service-content-info">
							...
							<ul>
								...
								<li>Fans of the Dallas Cowboys (or your team)</li>
								<li>Crafts</li>
								<li>Things to see in Denver (or in your city)</li>
								<li>Kayaking in Missouri (or your area)</li>
								<li>Good cruises to take</li>
								<li>I’m learning Spanish (or any language)</li>
								<li>Favorite songs of the 80’s</li>
								<li>Favorite songs of the 80’s</li>
								<li>Fans of Michael Jordan (or your favorite player)</li>
								<li>Breakfast food recipes (Spanish, Thai, BBQ, etc.…)</li>
							</ul>
						</div>
					</div>
				</div>
	...
	<!-- <section class="whyus-section">
		<div class="container">
			<div class="row">
				<div class="col-md-5 col-lg-5 col-sm-5">
					<div class="whyus-media">
						<div class="whyus-media-1">
							<img src="{{ assets('assets/special/images/w1.jpg') }}">
						</div>
						<div class="whyus-media-2">
							<img src="{{ assets('assets/special/images/w2.jpg') }}">
						</div>
						<div class="whyus-media-3">
							<img src="{{ assets('assets/special/images/w3.jpg') }}">
						</div>
					</div>
				</div>
				<div class="col-md-7 col-lg-7 col-sm-7">
					<div class="whyus-content-info">
	...
	<!-- <section class="Video-section">
		<div class="container">
			<div class="Video-card">
				<a href="#">
					<img src="{{ assets('assets/special/images/video.jpg') }}">
				</a>
			</div>
		</div>
	</section> -->
			...
			<div class="row">
				<div class="col-md-4">
					<div class="pricing-card">
						...
						<div class="pricing-body">
							<ul>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">1 Journal entry per day</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">1 Routine per day</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">1 Image per journal entry</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">You may view communities</li>
							</ul>
						</div>
				...
				<div class="col-md-4">
					<div class="pricing-card">
						...
						<div class="pricing-body">
							<ul>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">2 Journal entries per day</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">2 Routines per day</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">2 Images per journal entry</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">You may post in existing communities</li>
							</ul>
						</div>
						<div class="pricing-foot">
							<div class="price-info">
				...
				<div class="col-md-4">
					<div class="pricing-card">
						...
						<div class="pricing-body">
							<ul>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">5 Journal entries per day</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">5 Routines per day</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">5 Images per journal entry</li>
								<li><img src="{{ assets('assets/special/images/tick-circle.svg') }}">Create your own communities for people to follow/ App Approval Required</li>
							</ul>
						</div>
						<div class="pricing-foot">
							<div class="price-info">
	...
	<section class="contactus-page-section">
		...
		<div class="contactus-page-form">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-7 col-lg-7 col-sm-7">
						<div class="contactus-info-media text-center">
							<img src="{{ assets('assets/special/images/contact.svg') }}" height="500">
						</div>
					</div>
					<div class="col-md-5 col-lg-5 col-sm-5">
